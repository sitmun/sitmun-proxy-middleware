...
public class TestUtils {
  ...
  public static String requestAuthorization(MockMvc mvc) throws Exception {
    UserPasswordAuthenticationRequest login =
        UserPasswordAuthenticationRequest.builder()
    ...
    String authorization =
        mvc.perform(
                post(URIConstants.AUTHORIZATION_URI)
  ...
  public static String requestAuthorization(RestTemplate restTemplate) {
    ...
    ResponseEntity<AuthenticationResponse> loginResponse =
        restTemplate.postForEntity(
            URIConstants.AUTHORIZATION_URI, login, AuthenticationResponse.class);
